...
class Game {
	...
	public boolean isCorrectGuess() {
		...
		if ( systemInput == userInput ) {
			...
			switch(noOfGuesses) {
				case 1:
				System.out.println("Your obtained the score is 100");
				break;
				case 2:
				System.out.println("Your obtained the score is 90");
				break;
				case 3:
				System.out.println("Your obtained the score is 80");
				break;
				case 4:
				System.out.println("Your obtained the score is 70");
				break;
				case 5:
				System.out.println("Your obtained the score is 60");
				break;
				case 6:
				System.out.println("Your obtained the score is 50");
				break;
				case 7:
				System.out.println("Your obtained the score is 40");
				break;
				case 8:
				System.out.println("Your obtained the score is 30");
				break;
				case 9:
				System.out.println("Your obtained the score is 20");
				break;
				case 10:
				System.out.println("Your obtained the score is 10");
				break;
			}
			System.out.println();
			return true;
			...
			if ( userInput - systemInput > 10 ) {
				System.out.println("Msg:  Your guess is Too High, go for less number");
			}
			else {
				System.out.println("Msg:  Your guess is Little High, go for less number");
			}
		}
		else if ( noOfGuesses < 10 && userInput < systemInput ) {
			if ( systemInput - userInput > 10 ) {
				System.out.println("Msg:  Your guess is Too low, go for higher number");
			}
			else {
				System.out.println("Msg:  Your guess is Little low, go for higher number");
			}
		}
		return false;
	}
